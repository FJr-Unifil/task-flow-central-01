...
const Register = () => {
    ...
    try {
      ...
      if (success) {
        toast({
          ...
          description: "Bem-vindo ao Task Manager!",
        });
        navigate('/dashboard');
      } else {
  ...
  const handleGoogleRegister = async () => {
    ...
    try {
      ...
      setGeneralError('Erro ao criar conta com Google');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleAppleRegister = async () => {
    ...
    try {
      ...
      setGeneralError('Erro ao criar conta com Apple');
    } finally {
      setIsLoading(false);
    }
  };
            ...
            <CardContent className="space-y-6 relative z-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="name" className="text-sm font-medium text-gray-700 dark:text-gray-200 flex items-center space-x-1">
                ...
                <div className="space-y-2">
                  <Label htmlFor="confirmPassword" className="text-sm font-medium text-gray-700 dark:text-gray-200 flex items-center space-x-1">
                    <Lock className="h-4 w-4" />
